 ...
 * of the marking procedure for this lab. * @author kclowes
 */
public class ComplexTry {
    /**
     * The output should be: * <pre>
     * a = 1.0 + i2.0
     * b (-a) = -1.0 - i2.0 * c = 2.0 + i3.0
     * d (a + c) = 3.0 + i5.0
     * e (a - c) = -1.0 - i1.0
     * * f (1 / a) = 0.2 - i0.4
    ...
    ComplexNumber a, b, c, d, e, f, g, h; a = new ComplexNumber(1, 2);
    ...
    h = a.multiply(c); System.out.println("h (a * c) = " + h);
    }
}